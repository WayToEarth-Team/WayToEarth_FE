// src/features/guestbook/components/GuestbookCreateModal.tsx
...
import { PositiveAlert, NegativeAlert, MessageAlert, DestructiveConfirm, ConfirmAlert } from "@shared/ui/AlertDialog";
import {
  createGuestbook,
